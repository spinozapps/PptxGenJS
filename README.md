...
# https://github.com/gitbrent/PptxGenJS/pull/1017/commits
git cherry-pick 9267644

# https://github.com/gitbrent/PptxGenJS/pull/1021/commits
git cherry-pick e3c8ed5d564db79b70edbffb0032d7acae3dfcf4
...
git tag v3.8.0-spinozapps.4
git push spinozapps v3.8.0-spinozapps.4
```
